...
#invit{
    ...
    #contact form label {
        margin: 5px;
        /* Réduire les marges des labels */
    }

    #contact input,
    #contact textarea {
        width: calc(100% - 20px);  // Largeur adaptée aux écrans plus petits
        margin: 0 10px;
    }

    #contact form button {
        width: calc(100% - 20px);  // Largeur du bouton ajustée pour écrans plus petits
        margin: 10px auto 0;
        justify-content: center;
    }
